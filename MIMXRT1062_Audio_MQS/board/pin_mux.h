...
#define BOARD_INITPINS_CSI_PWDN_PERIPHERAL                                   MQS   /*!< Peripheral name */
#define BOARD_INITPINS_CSI_PWDN_SIGNAL                                     RIGHT   /*!< Signal name */

/* GPIO_AD_B0_05 (coord G14), CAN_STBY/BOOT_MODE[1]/Flash_RST/U12[8] */
/* Routed pin properties */
#define BOARD_INITPINS_CAN_STBY_PERIPHERAL                                   MQS   /*!< Peripheral name */
#define BOARD_INITPINS_CAN_STBY_SIGNAL                                      LEFT   /*!< Signal name */

/* GPIO_AD_B0_08 (coord F13), JTAG_MOD */
/* Routed pin properties */
#define BOARD_INITPINS_Audio_SD_PERIPHERAL                                 GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_Audio_SD_SIGNAL                                   gpio_io   /*!< Signal name */
#define BOARD_INITPINS_Audio_SD_CHANNEL                                       8U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_Audio_SD_GPIO                                       GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_Audio_SD_GPIO_PIN                                      8U   /*!< GPIO pin number */
#define BOARD_INITPINS_Audio_SD_GPIO_PIN_MASK                         (1U << 8U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_Audio_SD_PORT                                       GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_Audio_SD_PIN                                           8U   /*!< PORT pin number */
#define BOARD_INITPINS_Audio_SD_PIN_MASK                              (1U << 8U)   /*!< PORT pin mask */
