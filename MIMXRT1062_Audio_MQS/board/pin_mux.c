...
- {pin_num: F13, pin_signal: GPIO_AD_B0_08, label: JTAG_MOD, identifier: Audio_SD}
...
- pin_list:
  ...
  - {pin_num: G14, peripheral: MQS, signal: LEFT, pin_signal: GPIO_AD_B0_05}
  - {pin_num: F13, peripheral: GPIO1, signal: 'gpio_io, 08', pin_signal: GPIO_AD_B0_08, direction: OUTPUT, gpio_init_state: 'true', pull_up_down_config: Pull_Up_22K_Ohm}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of Audio_SD on GPIO_AD_B0_08 (pin F13) */
  gpio_pin_config_t Audio_SD_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_08 (pin F13) */
  GPIO_PinInit(GPIO1, 8U, &Audio_SD_config);
  ...
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_08_GPIO1_IO08, 0xF0A0U); 
